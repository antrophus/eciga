						...
						<div>
							...
							<ul id="viewArea">
								...
								<li>
									...
									<div class="view">
										<div class="itemimg">
											<img src="https://noticon-static.tammolo.com/dgggcrkxq/image/upload/v1603679366/noticon/dcvetqndre7gda3ttijy.gif" alt="하이브리드 2.0 카고컨테이너 에디션">
										</div>
										<div class="view_txt">
											<div class="">하이브리드 2.0 카고컨테이너</div>
											<div class="color">색상 : gold</div>
										</div>
										<div class="view_price">88,000원</div>
									</div>
									<div class="view_cnt">
										<div>수량</div>
										<div>1</div>
